...
This data package contains the data that powers the chart ["Annual change in forest area"](https://ourworldindata.org/grapher/annual-change-forest-area?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 20, 2026.
...
Net change in forest area measures forest expansion (the sum of afforestation and natural expansion) minus deforestation.
