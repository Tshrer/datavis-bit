...
This data package contains the data that powers the chart ["Share of land covered by forest"](https://ourworldindata.org/grapher/forest-area-as-share-of-land-area?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
